(window['webpackJsonp'] = window['webpackJsonp'] || []).push([['messages'], {
  ...
  c7da: function(e, t, i) {
    'use strict'
    i.r(t), i.d(t, 'settings', (function() {return s}))
    ...
    var n = {
      ...
      ba: {
        ...
        intro: {
          ...
          media: 'img/intro.jpg',
          content: 'Pritisnite Tačno ili Netačno na ovoj stranici da biste otkrili istinu o najboljem seksu, veličini kurca i bogatstvu. <br/> <br/>Budite oprezni, ova stranica može vam promijeniti život. U svakom slučaju, smisao toga shvatit će oni koji razmišljaju o budućnosti i žele poboljšati svoj život. ',
          button: 'Da, spreman sam!'
        },
        quiz: {
          1: {
            question: {
              title: 'Da li je tačno da je prosječna veličina penisa 6 inča?  ',
              media: 'img/slide1.jpg',
              result: false
            },
            answer: {
              title: 'Lažno je!',
              media: 'img/slide1-1.jpg',
              content: 'Većina muškaraca {GEO} obično ima 6,2-7 inča. Ako je manje onda ne brinite. Nema ništa lično. Majka priroda jednostavno ne favorizira sve. Međutim, to se može popraviti. '
            }
          },
          2: {
            question: {
              title: 'Da li je tačno da 63% žena lažira orgazam kako bi zadovoljilo muškarca i njegov mali penis? ',
              media: 'img/slide2.jpg',
              result: true
            },
            answer: {
          ...
          7: {
            ...
            answer: {
              title: 'Da, istina je!',
              media: 'img/slide7-1.jpg',
              content: 'Prestaje rasti nakon 18. Međutim, njegova se veličina još uvijek može povećati. Dakle, čak i teških 3,7 inča mogu se okrenuti za 6-8 inča bez ikakvih operacija. '
            }
          },
          8: {
            question: {
              title: 'Da li je tačno da neke kreme mogu promijeniti veličinu penisa?',
              media: 'img/slide8.jpg',
              result: true
            },
            answer: {
          ...
          9: {
            ...
            answer: {
              title: 'Da, istina je.',
              media: 'img/slide9-1.jpg',
              content: 'Samo 3% muškaraca spremno je biti odgovorno za svoj život, umjesto da krive prirodu i sve druge. Samo 3% je spremno nešto promijeniti i djelovati. Samo su posebni ljudi sposobni nešto promijeniti! <br/><br/>" Znam puno muškaraca. 90% njih su slabići. Oni će patiti cijelog života. Živjeti u govnima. Biti zadovoljni kakvi jesu. Nikada neće ići sa klasičnom plavušom. Nikada neće zaraditi novac. I nikada neće živjeti svoj najbolji život. Oni su samo gubitnici. Oni su u redu s tim sranjem u svom ličnom životu, karijeri. I oni od toga žive. Oni su samo idioti i kukavice. "<br/>Rekao je Jason Statham u jednom svom intervjuu. '
            }
          },
          10: {
            question: {
              title: 'Da li je tačno da 50% muškaraca sa velikim penisima dobiju to od rođenja??',
              media: 'img/slide10.jpg',
              result: false
            },
            answer: {
              title: 'Ne, nije tačno ',
              media: 'img/slide10-1.jpg',
              content: 'Samo šačica muškaraca od rođenja može imati veliki penis. U stvarnosti se više od polovine velikih penisa povećalo uz pomoć prirodnih krema. '
            }
          }
        },
        results: {
      ...
      bg: {
        ...
        intro: {
          title: 'Правда или ложь?',
          media: 'img/intro.jpg',
          content: 'Изберете Вярно или Невярно на този саит, за да разберете исината за най-добрия секс, размер на пениса и парите. <br/> <br/>Внимавайте, този сайт може да промени живота ви. Смисълът му ще бъде разбран от онези, които мислят за бъдещето и искат да подобрят живота си. ',
          button: 'Да, готов съм!'
        },
        quiz: {
          1: {
            ...
            answer: {
              title: 'Не е вярно!',
              media: 'img/slide1-1.jpg',
              content: 'Повечето от {GEO} мъжете обикновено са с 15-17 см. Ако е ви е по-малък, не се притеснявайте. Няма нищо лично. Майката природа просто не е надарила всички, но това може да се оправи. '
            }
          },
          2: {
            question: {
              title: 'Вярно ли е, че 63% от жените имитират оргазъм, за да задоволят мъжа и малкия му пенис?  ',
              media: 'img/slide2.jpg',
              result: true
            },
            answer: {
              title: 'Да, вярно е! ',
              media: 'img/slide2-1.jpg',
              content: 'През юли 2019 г. британските социални учени са провели изследване сред жени и са открили, че повече от половината имитират оргазъм или каквото и да е удоволствие. Можете да прочетете за това изследване на официалния сайт на Изследователския отдел на Обединеното кралство.  <br/><br/>Истината е, че жените имат определена точка, кояйто е отговорна за удоволствието. Единствено пенис, който е от 17-22 см може да я достигне. Учените го нарекоха точка 11 в чест на Мариана Падина (известната падина, която е 11 000 км). <br/><br/>Както се оказва, всички жени мечтаят за голям и дълъг пенис, който ще им позволи да пронокнат по на дълбоко от Марианската Падина. Те искат техният мъж да ги чука силно. Те искат техният мъж да свърши на лицето им. Но всъщност всичко, което получават ... Това е нещо, от което се срамуват ...  '
            }
          },
          3: {
            question: {
              title: 'Вярно ли е, че само мъжете с големи пениси (17 см и нагоре) могат напълно да се насладят на секса? ',
              media: 'img/slide3.jpg',
              result: true
            },
            answer: {
          ...
          4: {
            ...
            answer: {
              ...
              content: 'Онлайн проучване на Playboy е интервюирало повече от 100 000 мъже и потвърди тази теория! <br/><br/>Вижте статистиката. <br/><br/>Всъщност само мъжете с голям размер могат да имат продължителни сексуални актове. Това се дължи на факта, че големите пениси са много по-твърди и могат да съдържат повече. Тези мъже имат много тестостерон и сериозни топки. <br/><br/>Те могат да чукат кучките си цяла нощ. Жените могат само силно да стенят, да поглъщат тонове сперма и нетърпеливо да смучат пениса на притежателя му. Между другото, такива мъже могат да наказват по три момичета наведнъж. '
            }
          },
          5: {
            question: {
              title: 'Вярно ли е, че мъж с пенис, дълъг 17 см и повече може да стане импотентен по-рано от останалите?',
              media: 'img/slide5.jpg',
              result: false
            },
            answer: {
          ...
          7: {
            ...
            answer: {
              title: 'Да, вярно е! ',
              media: 'img/slide7-1.jpg',
              content: ' Той спира да расте след 18. Въпреки това, размерът му все още може да бъде увеличен. Така че дори и 9 см могат да станат 15-20 см без никакви операции. '
            }
          },
          8: {
            question: {
              title: 'Вярно ли е, че някои кремове могат да променят размера на пениса?',
              media: 'img/slide8.jpg',
              result: true
            },
            answer: {
          ...
          10: {
            ...
            answer: {
              title: 'Не, не е вярно. ',
              media: 'img/slide10-1.jpg',
              content: 'Много малко мъже са родени така. В действителност повече от половината от големите пениси са били уголемени с помощта на натурални кремове. "'
            }
          }
        },
        results: {
      ...
      cz: {
        ...
        intro: {
          title: 'Правда или ложь?',
          media: 'img/intro.jpg',
          content: 'Stisknutím Pravda nebo Lež na tomto webu odhalíte pravdu o nejlepším sexu, velikosti ptáka a bohatství. <br/> <br/>Buďte opatrní, tento web může změnit váš život. Jeho smysl však pochopí ti, kdo přemýšlejí o budoucnosti a chtějí zlepšit svůj život. ',
        ...
        quiz: {
          1: {
            ...
            answer: {
              title: 'Je to lež! ',
              media: 'img/slide1-1.jpg',
              content: 'Většina mužů {GEO} má obvykle 6,2 až 7 palců. Pokud máte méně, nebojte se. Není nic osobního. Matka příroda prostě nezvýhodňuje každého. Lze to však napravit. '
            }
          },
          2: {
            question: {
              title: 'Je pravda, že 63 % žen předstírá orgasmus, aby uspokojilo muže a jeho malý penis?  ',
              media: 'img/slide2.jpg',
              result: true
            },
            answer: {
              ...
              media: 'img/slide2-1.jpg',
              content: 'V červenci 2019 provedli britští sociální vědci studii mezi ženami a zjistili, že více než polovina žen předstírá orgasmus a jakoukoli formu potěšení obecně... <br/><br/>Pravda je, že ženy mají určitý bod, který je zodpovědný za potěšení. Může jej však dosáhnout pouze penis o velikosti 7 až 9 palců. Vědci to nazvali Bod 11 na počest Mariánského příkopu (jeho známá hloubka je 11 000 km). <br/><br/>Jak se ukazuje, všechny ženy sní o velkém a dlouhém penisu, díky kterému budou hlubší než Mariánský příkop. Chtějí, aby jim jejich muž tvrdě šukal. Chtějí, aby se jejich muž udělal do jejich tváře. Ale ve skutečnosti všechno, co dostanou... Je to něco, za co se stydí...  '
            }
          },
          3: {
            question: {
              title: 'Je pravda, že sex si mohou plně užívat pouze majitelé velkých penisů (7 palců a více)? ',
              media: 'img/slide3.jpg',
              result: true
            },
            answer: {
              title: 'Ano, je to pravda! ',
              media: 'img/slide3-1.jpg',
              content: 'Čím větší je penis, tím silnější pocit potěšení. Evoluce dala majitelům velkých velikostí silnou erekci a fantastické orgasmy. Mrazení páteře, bití srdce, motýlci v žaludku, závratě.... Jeden z účastníků průzkumu porovnal tento pocit s okamžikem, kdy si sednete do svého nového Ferrari, nastartujete auto a šlápnete na plyn.<br/><br/>Když penis dosáhne Bodu 11, dochází k chemické reakci, kdy se produkují serotoniny a endorfiny. Takže obvykle muž s penisem 4-6 palců nic z toho necítí. '
            }
          },
          4: {
            question: {
              title: 'Je pravda, že existuje integrální vztah mezi dobou trvání sexu a velikostí penisu?',
              media: 'img/slide4.jpg',
              result: true
            },
            answer: {
          ...
          7: {
            ...
            answer: {
              ...
              media: 'img/slide7-1.jpg',
              content: ' Po 18 letech přestane růst. Jeho velikost však lze stále zvětšit. Takže i tvrdých 3,7 palce se mohou zvětšit na 6 až 8 palců bez jakýchkoli operací. '
            }
          },
          8: {
            question: {
              title: 'Je pravda, že některé krémy mohou měnit velikost penisu?',
              media: 'img/slide8.jpg',
              result: true
            },
            answer: {
          ...
          10: {
            ...
            answer: {
              ...
              media: 'img/slide10-1.jpg',
              content: 'Jen hrstka mužů může mít velký penis od narození. Ve skutečnosti více než polovina velkých penisů byla rozšířena pomocí přírodních krémů. "'
            }
          }
        },
        results: {
      ...
      sk: {
        ...
        intro: {
          title: 'Правда или ложь?',
          media: 'img/intro.jpg',
          content: 'Stlačením Pravda alebo Lož na tomto webe odhalíte pravdu o najlepšom sexe, veľkosti vtáka a bohatstve. <br/> <br/>Buďte opatrní, tento web môže zmeniť váš život. Jeho zmysel však pochopia tí, ktorí premýšľajú o budúcnosti a chcú zlepšiť svoj život. ',
        ...
        quiz: {
          1: {
            ...
            answer: {
              title: 'Je to lož!',
              media: 'img/slide1-1.jpg',
              content: 'Väčšina mužov {GEO} má obvykle 6,2 až 7 palcov. Ak máte menej, nebojte sa. Nie je nič osobné. Matka príroda jednoducho nezvýhodňuje každého. Možno to však napraviť. '
            }
          },
          2: {
            question: {
              title: 'Je pravda, že 63 % žien predstiera orgazmus, aby uspokojilo muža a jeho malý penis?  ',
              media: 'img/slide2.jpg',
              result: true
            },
            answer: {
          ...
          4: {
            ...
            answer: {
              ...
              content: 'Online prieskum na webe Playboy vykonal rozhovor s viac ako 100 000 mužmi a túto teóriu podporil! <br/><br/>Pozrite sa na štatistiku. <br/><br/>Dlhé sexuálne akty môžu mať v skutočnosti len veľké veľkosti. Dôvodom je skutočnosť, že veľké penisy sú oveľa tvrdšie a môžu pojať viac. Tí chlapi majú veľa testosterónu a vážne gule. <br/><br/>Môžu šukať svoje kurvy celú noc. Ženy môžu len hlasno stonať, prehĺtať tony spermií a dychtivo sať penis svojho majiteľa. Mimochodom, takí chlapi môžu trestať tri dievčatá naraz.'
            }
          },
          5: {
            question: {
              title: 'Je pravda, že muž s penisom 17cm a viac môže mať impotenciu skôr ako ostatní?',
              media: 'img/slide5.jpg',
              result: false
            },
            answer: {
          ...
          7: {
            ...
            answer: {
              ...
              media: 'img/slide7-1.jpg',
              content: 'Po 18 rokoch prestane rásť. Jeho veľkosť však možno stále zväčšiť. Takže aj tvrdých 3,7 palca sa môžu zväčšiť na 6 až 8 palcov bez akýchkoľvek operácií. '
            }
          },
          8: {
            question: {
              title: 'Je pravda, že niektoré krémy môžu meniť veľkosť penisu?',
              media: 'img/slide8.jpg',
              result: true
            },
            answer: {
          ...
          10: {
            ...
            answer: {
              ...
              media: 'img/slide10-1.jpg',
              content: 'Len hŕstka mužov môže mať veľký penis od narodenia. V skutočnosti viac ako polovica veľkých penisov bola rozšírená pomocou prírodných krémov. '
            }
          }
        },
        results: {
      ...
      ge: {
        ...
        intro: {
          title: 'Правда или ложь?',
          media: 'img/intro.jpg',
          content: 'დააწექით მართალიას ან ტყუილიას ამ საიტზე, რომ გამოააშკარაოთ სიმართლე საუკეთესო სექსზე, პენისის ზომაზე და სიმდიდრეზე. <br/> <br/>ფრთხილად იყავით, ამ საიტს შეუძლია შეცვალოს თქვენი ცხოვრება. ამ ყველაფერს ისინი გაიგებენ ვისაც სურთ, რომ გაიუმჯობესონ ჯანმრთელობა და რომლებიც ფიქრობენ მომავალზე.',
          button: 'დიახ, მე მზად ვარ!'
        },
        quiz: {
          1: {
            question: {
              title: 'მართალია თუ არა, რომ საშუალო პენისის ზომა 15 სანტიმეტრია?',
              media: 'img/slide1.jpg',
              result: false
            },
            answer: {
              title: 'ეს ტყუილია! ',
              media: 'img/slide1-1.jpg',
              content: 'მამაკაცების უმეტესობას აქვს 16-18 სანტიმეტრი . თუ თქვენი პენისის ზომა ამაზე ნაკლებია არ ინერვიულოთ. არაფერია სანერვიულო. ბუნება ყველას არ აჯილდოვებს, მაგრამ ამის შეცვლა შესაძლებელია. '
            }
          },
          2: {
            question: {
              title: 'Jმართალია თუ არა, რომ ქალების 63%  თავს იკატუნებს, ვითომ ორგაზმს განიცდიან, რათა დააკმაყოფილონ პატარა პენისის მქონე მამაკაცი? ',
              media: 'img/slide2.jpg',
              result: true
            },
            answer: {
          ...
          3: {
            ...
            answer: {
              title: 'დიახ, ეს მართალია!',
              media: 'img/slide3-1.jpg',
              content: 'რაც უფრო დიდია პენისი, მით უფრო დიდია შეგრძნება და სიამოვნება. დიდი პენისის მქონე ადამიანებს აქვთ ძლიერი ერექცია და საუკეთესო ორგაზმი. ასევე დაწყნარებული ხერხემალი, გულის ცემა.<br/>ერთ-ერთმა გამოკვლევის მონაწილემ ეს შეგრძნება შეადარა იმ მომენტს, როდესაც შენს ახალ ფერარის მარკის მანქანაში ჩაჯდები, ჩართავ მანქანას და მიაჭერ გაზს.<br/>როდესაც პენისი მიაღწევს ზემოთ ნახსენებ ადგილ 11ს, ამ დროს ქიმიური რეაქცია ხდება, როდესაც სეროტინი და ენდორფინი წარმოიქმნება. ანუ, მამაკაცი, რომელსაც 10-15 სანტიმეტრიანი პენისი აქვს ასეთ რამეს ვერ იგრძნობს. '
            }
          },
          4: {
            question: {
              title: 'მართალია თუ არა, რომ პენისის ზომა და სექსის ხანგრძლივობა ერთმანეთში კავშირში არიან?',
              media: 'img/slide4.jpg',
              result: true
            },
            answer: {
          ...
          7: {
            ...
            answer: {
              title: 'დიახ, მართალია! ',
              media: 'img/slide7-1.jpg',
              content: 'ის წყვეტს ზრდას 18 წლის შემდეგ, მაგრამ მაინც შესაძლებელია მისი გაზრდა ხელოვნურად. ამგვარად, 8-17 სანტიმეტრიანიც კი შეიძლება გადაიქცეს 15-20ად, ყველანაირი ოპერაციების გარეშე. '
            }
          },
          8: {
            question: {
              title: 'მართალია, რომ ზოგ კრემს შეუძლია პენისის ზომის შეცვლა?',
              media: 'img/slide8.jpg',
              result: true
            },
            answer: {
          ...
          10: {
            ...
            answer: {
              title: 'Nie, nie je to pravda.',
              media: 'img/slide10-1.jpg',
              content: '*тут нет перевода на грузинский*Len hŕstka mužov môže mať veľký penis od narodenia. V skutočnosti viac ako polovica veľkých penisov bola rozšírená pomocou prírodných krémov. '
            }
          }
        },
        results: {
          options: [{
            ...
            message1: 'Результат лучше чем у <strong>50%</strong> тестируемых',
            message2: 'თქვენ ნამდვილად გაკლიათ ინფორმაციულობა. არაუშავს! <img src="img/fire.png">',
            message3: 'ჩვენ იმედი გვაქვს, რომ ეს ტესტი დაგეხმარათ გამოგეაშკარავებინათ ახალი ფაქტები მამაკაცის ფიზიოლოგიზე და ვიმედოვნებთ, რომ ჩვენ რჩევებს ბრძნულად გამოიყენებთ.<br/> გინდათ რომ შეწყვიტოთ თავის შეურაწყოფილად გრძნობა? გინდათ რომ გაიგოთ როგორია ნამდვილი სექსი და ორგაზმი? მაშინ დროა შეწყვიტოთ წუწუნი. გაბედე მოქმედება! შეუკვეთე მარალ გელი და იყავი შენი ცხოვრების კონტროლში.<br/> ჩვენ გვაქვს ფასდაკლება მხოლოდ შენთვის ლეგენდარულ მარალ გელზე, რასაც შეუძლია გაგიზარდოს პენისი 5-15 სანტიმეტრით.'
           }, {
            mask: {
              from: 8,
